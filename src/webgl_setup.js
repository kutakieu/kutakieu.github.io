...
// onload
export function setup_canvas(c, c_width, c_height, vert_shader, frag_shder){
	
	// canvas サイズ
	cw = c_width; ch = c_height;
	...
	// シェーダ周りの初期化
	var prg = create_program(create_shader(vert_shader, gl.VERTEX_SHADER), create_shader(frag_shder, gl.FRAGMENT_SHADER));
