...
export function setup_canvas(c, c_width, c_height, shader0, shader1, shader2){
	var i, j;
	...
	// c.width = Math.min(c.width, c_height);
	// c.height = c.width;
	...
	var pPrg = create_program(create_shader(shader2.vert, gl.VERTEX_SHADER), create_shader(shader2.frag, gl.FRAGMENT_SHADER));
	...
	var vPrg = create_program(create_shader(shader1.vert, gl.VERTEX_SHADER), create_shader(shader1.frag, gl.FRAGMENT_SHADER));
	...
	var dPrg = create_program(create_shader(shader0.vert, gl.VERTEX_SHADER), create_shader(shader0.frag, gl.FRAGMENT_SHADER));
	...
	// シェーダを生成する関数
	function create_shader(shader_txt, shader_type){
		// シェーダを格納する変数
